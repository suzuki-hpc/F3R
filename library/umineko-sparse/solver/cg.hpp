#ifndef UMINEKO_SPARSE_SOLVER_CG_HPP
#define UMINEKO_SPARSE_SOLVER_CG_HPP

#include "umineko-sparse/models.hpp"

namespace kmm {

template <typename T, class L> struct CG {
  ...
  CG(const CoefficientMatrix<L> A, const Operator<L> M, params param)
