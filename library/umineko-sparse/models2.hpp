...
template <class L> struct Operator {
  ...
  struct Concept {
    ...
    virtual void operate(const vec_t<_Float16> &in, vec_t<_Float16> out) const = 0;
    virtual void operate(const vec_t<double> &in, vec_t<_Float16> out) const = 0;
    virtual void operate(const vec_t<_Float16> &in, vec_t<double> out) const = 0;
    virtual void operate(const vec_t<float> &in, vec_t<_Float16> out) const = 0;
    virtual void operate(const vec_t<_Float16> &in, vec_t<float> out) const = 0;
  ...
  template <typename T> struct Model final : Concept {
    ...
    KMM_DEFINE_OPERATE(_Float16, _Float16);
    KMM_DEFINE_OPERATE(double, _Float16);
    KMM_DEFINE_OPERATE(_Float16, double);
    KMM_DEFINE_OPERATE(float, _Float16);
    KMM_DEFINE_OPERATE(_Float16, float);
...
#define DEF_OPERATE(in_t, out_t)                                                    \
  void operate(const vec_t<in_t> &in, vec_t<out_t> out) const override {            \
    ...
    DEF_OPERATE(_Float16, _Float16);
    DEF_OPERATE(double, _Float16);
    DEF_OPERATE(_Float16, double);
    DEF_OPERATE(float, _Float16);
    DEF_OPERATE(_Float16, float);
#undef DEF_OPERATE
    [[nodiscard]] idx_t nrows() const override { return object.nrows(); }
    [[nodiscard]] idx_t ncols() const override { return object.ncols(); }
...
template <class L> struct CoefficientMatrix {
  ...
  struct Concept {
    ...
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<_Float16> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<double> &, const vec_t<_Float16> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<double> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<_Float16> &, vec_t<double>) const = 0;
    virtual void compute_residual(
        const vec_t<float> &, const vec_t<_Float16> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<float> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<_Float16> &, vec_t<float>) const = 0;
    
    virtual void compute_residual(
        const vec_t<double> &, const vec_t<double> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<float> &, const vec_t<double> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<double> &, const vec_t<float> &, vec_t<_Float16>) const = 0;
    virtual void compute_residual(
        const vec_t<float> &, const vec_t<float> &, vec_t<_Float16>) const = 0;

    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<double> &, vec_t<double>) const = 0;
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<float> &, vec_t<double>) const = 0;
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<double> &, vec_t<float>) const = 0;
    virtual void compute_residual(
        const vec_t<_Float16> &, const vec_t<float> &, vec_t<float>) const = 0;

    virtual void compute_residual(
        const vec_t<double> &, const vec_t<_Float16> &, vec_t<double>) const = 0;
    virtual void compute_residual(
        const vec_t<float> &, const vec_t<_Float16> &, vec_t<double>) const = 0;
    virtual void compute_residual(
        const vec_t<double> &, const vec_t<_Float16> &, vec_t<float>) const = 0;
    virtual void compute_residual(
        const vec_t<float> &, const vec_t<_Float16> &, vec_t<float>) const = 0;
  ...
  template <typename T> struct Model : Concept {
    ...
    KMM_DEFINE_COMP_RES(_Float16, _Float16, _Float16);
    KMM_DEFINE_COMP_RES(double, _Float16, _Float16);
    KMM_DEFINE_COMP_RES(_Float16, double, _Float16);
    KMM_DEFINE_COMP_RES(_Float16, _Float16, double);
    KMM_DEFINE_COMP_RES(float, _Float16, _Float16);
    KMM_DEFINE_COMP_RES(_Float16, float, _Float16);
    KMM_DEFINE_COMP_RES(_Float16, _Float16, float);

    KMM_DEFINE_COMP_RES(double, double, _Float16);
    KMM_DEFINE_COMP_RES(float, double, _Float16);
    KMM_DEFINE_COMP_RES(double, float, _Float16);
    KMM_DEFINE_COMP_RES(float, float, _Float16);

    KMM_DEFINE_COMP_RES(_Float16, double, double);
    KMM_DEFINE_COMP_RES(_Float16, double, float);
    KMM_DEFINE_COMP_RES(_Float16, float, double);
    KMM_DEFINE_COMP_RES(_Float16, float, float);

    KMM_DEFINE_COMP_RES(double, _Float16, double);
    KMM_DEFINE_COMP_RES(float, _Float16, double);
    KMM_DEFINE_COMP_RES(double, _Float16, float);
    KMM_DEFINE_COMP_RES(float, _Float16, float);
